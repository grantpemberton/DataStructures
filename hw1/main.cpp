...
/*
{
	...
	List_dynamic_array test;
	Card card1 ('A', 'D');
	Card card2 ('2', 'S');
	Card card3 ('3', 'C');
	Card card4 ('4', 'H');
	test.print_list();
	test.insert_at_head(card4);
	test.insert_at_head(card3);
	test.insert_at_head(card2);
	test.insert_at_head(card1);
// list is full of cards 1 trhough 4
*/
///*
{
